...
const Navbar = () => {
  return (
    <nav className='h-14 flex items-center justify-between p-4 bg-[#9159d1] text-white'>
      ...
      <a href="https://github.com/vidhigupta14">
        <lord-icon
          src="https://cdn.lordicon.com/jjxzcivr.json"
          trigger="hover"
          stroke="bold"
          colors="primary:#e5d1fa,secondary:#ffffff"
